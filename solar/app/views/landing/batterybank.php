		...
		function graph(){
			...
			switch (data){
				...
				case voltdata:
					...
					$('.graph-label').html("<center>Graph of Battery Bank's Voltage (in Volts) </center>");
				break;

				case currentdata:
					maxcurrent = <?php echo $maxcurrent; ?>;
					stepwidth = Math.ceil(maxcurrent / 5);
					$('.graph-label').html("<center>Graph of Battery Bank's Current (in MilliAmperes) </center>");
				break;

				case powerdata:
					maxpower = <?php echo $maxpower; ?>;
					stepwidth = Math.ceil(maxpower / 5);
					$('.graph-label').html("<center>Graph of Battery Bank's Power (in Watts) </center>");
				break;
			}
